function aula() {
    ...
    if(value == 0){
        ...
        root.style.setProperty('--color-blue', '#4A90E2');
        return;
    }
    ...
    if (selectedOption.id.includes('centrale')) {
        ...
        root.style.setProperty('--color-blue', '#D02727');
        if(value.slice(-1) == 1){
        ...
        root.style.setProperty('--color-blue', 'green');
        if(value.slice(-1) == 1){
        ...
        root.style.setProperty('--color-blue', 'orange');
